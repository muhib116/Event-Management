    ...
    <div v-if="!isEmpty(data)" class="offer-area">
        <div class="container">
            ...
            <div class="row relative">
                ...
                <div class="absolute top-1/2 transform -translate-y-10 flex gap-2 w-full justify-between ml-[5px] pointer-events-none">
                    <button @click="myCarousel.prev()" class="px-[12px] py-2 rounded bg-[#172853] text-white pointer-events-auto">
                    ...
                    <button @click="myCarousel.next()" class="px-[12px] py-2 rounded bg-[#172853] text-white pointer-events-auto">
